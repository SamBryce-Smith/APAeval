...
# Identify significantly regulated 3'UTR APA events between the two conditions
...
description = "Identify significantly regulated 3'UTR APA events\n"
...
option_list = list(
  ...
  make_option(
    ...
    type = "character",
    default = FALSE,
    help = "Relative expression of 3'UTR APA events from the counting step",
    metavar = "files"
  ),
  make_option(
    "--read_cutoff",
  ...
  make_option(
    ...
    type = "character",
    default = FALSE,
    help = "3'UTR APA differential output variables to postprocess",
    metavar = "files"
  ),
  make_option(
    "--out_diff_tsv",
    ...
    type = "character",
    default = FALSE,
    help = "Full 3'UTR APA differential results table",
    metavar = "files"
  ),
  make_option(
    c("-h", "--help"),
